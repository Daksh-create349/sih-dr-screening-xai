...
[![Clinical Sensitivity](https://img.shields.io/badge/Rural%20Triage-99.27%25%20Sensitivity-b91c1c.svg?style=flat-square)](#1-classification--triage-operating-points)
[![Clinical Integrity](https://img.shields.io/badge/Integrity-Zero%20Synthetic%20Data-059669.svg?style=flat-square)](#epistemic-integrity-principles)
...
### Point-of-Care Ingestion vs. Multi-Modal Synthesis

<div align="center">
<table>
  <tr>
    <td align="center" width="50%">
      <img src="docs/assets/clinical_original_fundus.png" width="95%" style="border-radius: 6px; border: 1px solid #475569;" /><br/>
      <strong>Raw Frontline Fundus Ingestion (45° FOV)</strong><br/>
      <sub>Native unenhanced color retinal photography ingested at rural point-of-care tele-screening nodes.</sub>
    </td>
    <td align="center" width="50%">
      <img src="docs/assets/clinical_modalities_quad_panel.png" width="95%" style="border-radius: 6px; border: 1px solid #475569;" /><br/>
      <strong>Multi-Modal Diagnostic Synthesis</strong><br/>
      <sub>Simultaneous real-time derivation: Native Fundus, Frangi Hessian Angiogram, 6-Biomarker Overlay, and Grad-CAM Heatmap.</sub>
    </td>
  </tr>
</table>
</div>
...
<div align="center">
  ...
  <p><em>Figure 3: Grade 0 (No DR) — Clean retinal background, normal optic disc morphology, absence of microvascular leakage. Non-referable: Routine annual rescreening recommended.</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Figure 4: Grade 1 (Mild NPDR) — Isolated microaneurysms detected without hard exudate clusters or hemorrhages. Non-referable: 6–12 month follow-up screening scheduled.</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Figure 5: Grade 2 (Moderate NPDR) — Multiple microaneurysms, lipid hard exudates, and localized blot hemorrhages. Referable status triggered with CSME proximity evaluation.</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Figure 6: Grade 3 (Severe NPDR) — Extensive intraretinal hemorrhages spanning 4 quadrants (ICDR 4-2-1 rule), cotton wool spots, and vascular beading. Urgent ophthalmology triage.</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Figure 7: Grade 4 (PDR) — Neovascularization, severe vascular disruption, and high risk of vitreous hemorrhage or retinal detachment. Immediate same-week tertiary center referral.</em></p>
</div>
...
graph LR
    subgraph IQA_METRICS ["Independent Quality Scoring"]
        M1["Focus: Laplacian Energy Variance"]
        M2["Illumination: Entropy & Mean Brightness"]
        M3["FOV: Circular Aperture Cleanness"]
        M4["Centering: Optic Disc Quadrant Distance"]
    end
    
    M1 & M2 & M3 & M4 --> COMP["Weighted Composite Score (0–100)"]
    
    COMP --> G1["Score >= 65: GOOD (Proceed to Deep Inference)"]
    COMP --> G2["45 <= Score < 65: BORDERLINE (CLAHE Enhancement & Recheck)"]
...
### Clinical IQA Diagnostic Report Sheet

<div align="center">
  <img src="docs/assets/iqa_multi_metric_report.png" alt="Clinical IQA Diagnostic Report Card" width="95%" style="border-radius: 8px; border: 1px solid #334155; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" />
  <p><em>Figure 8: Automated Point-of-Care IQA Diagnostic Sheet — Detailed breakdown of Focus gradient, Illumination histogram, FOV circular boundary mask, and overall composite score.</em></p>
</div>

<br/>

### IQA Quantitative Metric Distributions & CLAHE Rescue

<div align="center">
<table>
  <tr>
    <td align="center" width="50%">
      <img src="docs/assets/iqa_component_benchmarks.png" width="95%" style="border-radius: 6px; border: 1px solid #475569;" /><br/>
      <strong>Component Quality Distributions Across Clinical Cohorts</strong><br/>
      <sub>Empirical separation of Good, Borderline, and Ungradeable captures across focus, illumination, and aperture metrics.</sub>
    </td>
    <td align="center" width="50%">
      <img src="docs/assets/iqa_enhancement_comparison.png" width="95%" style="border-radius: 6px; border: 1px solid #475569;" /><br/>
      <strong>Adaptive CLAHE Enhancement Delta</strong><br/>
      <sub>Measured quality score improvement rescuing Borderline captures into the diagnostically valid range without edge artifacts.</sub>
    </td>
  </tr>
</table>
</div>
...
### Authentic Multi-Patient Clinical Retinal Cohort

<div align="center">
  <img src="docs/assets/clinical_cohort_mosaic.png" alt="Clinical Retinal Cohort Mosaic" width="100%" style="border-radius: 8px; border: 1px solid #334155; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" />
  <p><em>Figure 9: Real Clinical Patient Cohort Mosaic — Comprehensive mosaic of authentic clinical fundus photography spanning all 5 ICDR grades (0 to 4) utilized for validation across APTOS and IDRiD benchmarks. Zero synthetic data.</em></p>
</div>
